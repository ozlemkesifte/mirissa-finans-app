...
public struct ChannelMonthResult: Hashable, Sendable, Identifiable {
    ...
    /// İade ve indirimin müşteri fiyatı cinsinden (KDV dahil) tutarı — reklam panelleri satışı
    /// iade/indirim düşmeden sayar; karşılaştırma için
    public var iadeIndirimIncVat: Kurus = 0
...
public extension Array where Element == ChannelMonthResult {
    ...
    func aggregated(channelId: Id, channelName: String, label: MonthKey) -> ChannelMonthResult {
        ...
        for c in self {
            ...
            r.iadeIndirimIncVat += c.iadeIndirimIncVat
